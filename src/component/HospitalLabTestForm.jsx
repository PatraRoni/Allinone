...
export default function HospitalLabTestForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="font-dmsans max-w-lg mx-auto py-20 px-6 bg-[#EDEFF2] rounded-2xl shadow flex flex-col gap-6">
      ...
      <button type="submit" className="bg-[#4052D6] hover:bg-indigo-700 text-white font-semibold py-4 px-6 rounded-lg tracking-tighter mt-4 self-center">Confirm Appointment</button>
    </form>
  )
}
